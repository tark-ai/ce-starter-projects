                        ...
                        <Link
                          to={
                            activeDropdown === "About"
                              ? (`/about/${subItem.toLowerCase().replace(/\s+/g, "-")}` as string)
                              : "/category/$category"
                          }
                          params={
                            activeDropdown !== "About"
                ...
                {navItems
                  ...
                  ?.images.map((image) => {
                    ...
                    if (activeDropdown === "Shop") {
                      ...
                      if (image.label === "Rings") linkParams = { category: "rings" };
                      else if (image.label === "Earrings") linkParams = { category: "earrings" };
                    } else if (activeDropdown === "New in") {
                      linkTo = "/product/$slug";
                      if (image.label === "Arcus Bracelet") linkParams = { slug: "arcus-bracelet" };
                      else if (image.label === "Span Bracelet")
                        linkParams = { slug: "span-bracelet" };
