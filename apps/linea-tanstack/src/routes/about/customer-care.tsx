...
export const Route = createFileRoute("/about/customer-care")({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: `Customer Care | ${SITE_NAME}` },
      {
        ...
        <ContentSection title="Frequently Asked Questions">
          <Accordion type="single" collapsible className="space-y-4">
            ...
            <AccordionItem value="warranty" className="border border-border rounded-lg px-6">
              ...
              <AccordionContent className="text-muted-foreground">
                All LINEA jewelry comes with a lifetime warranty against manufacturing defects. This
                includes free repairs for normal wear and tear, stone tightening, and professional
                cleaning.
              </AccordionContent>
            </AccordionItem>
            ...
            <AccordionItem value="care" className="border border-border rounded-lg px-6">
              ...
              <AccordionContent className="text-muted-foreground">
                Store pieces separately in soft pouches, avoid contact with chemicals and cosmetics,
                and clean gently with a soft cloth. We recommend professional cleaning every 6-12
                months.
              </AccordionContent>
            </AccordionItem>
            ...
            <AccordionItem value="authentication" className="border border-border rounded-lg px-6">
              ...
              <AccordionContent className="text-muted-foreground">
                ...
                can verify authenticity on our website using your unique piece number or contact our
                customer care team.
              </AccordionContent>
            </AccordionItem>
          </Accordion>
