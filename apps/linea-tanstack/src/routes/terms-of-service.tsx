  ...
  head: () => ({
    meta: [
      ...
      },
      {
        name: "description",
        content:
          "Review the terms and conditions governing the use of LINEA's website and services.",
      },
      {
        property: "og:title",
        content: `Terms of Service | ${SITE_NAME}`,
      },
      {
      ...
      { name: "twitter:title", content: `Terms of Service | ${SITE_NAME}` },
      {
        ...
        <div className="prose prose-lg max-w-none space-y-8">
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              content is accurate, complete, reliable, or error-free. We reserve the right to modify
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              not responsible for lost, stolen, or damaged packages once they have been delivered to
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              or products, even if we have been notified of the possibility of such damage.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              your use of our website and services, to understand our practices regarding your
