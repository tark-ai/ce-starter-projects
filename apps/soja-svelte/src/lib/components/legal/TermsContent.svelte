<script lang="ts">
import ContentSection from "../about/ContentSection.svelte";
import PageHeader from "../about/PageHeader.svelte";
</script>
...
<main>
      ...
      <ContentSection title="Orders">
        <p>
          ...
          cancel an order, and will refund any payment taken in full where we do so. Prices are
          shown in the currency indicated in the footer and include applicable taxes unless stated
          otherwise.
        </p>
      </ContentSection>
      ...
      <ContentSection title="Shipping">
        <p>
          Orders are shipped from Copenhagen. Complimentary international next-day shipping applies
          to orders above the threshold shown on our site. Delivery time frames are estimates and
          may vary with public holidays, courier delays and other circumstances beyond our control.
        </p>
      </ContentSection>

      <ContentSection title="Returns">
        <p>
          Unopened products may be returned within 30 days of delivery for a full refund. For
          hygiene reasons we cannot accept opened skincare products unless they are faulty. Contact
          us before returning anything so we can arrange the return.
        </p>
      </ContentSection>
      ...
      <ContentSection title="Contact" class="pb-24">
        <p>
