...
export const Route = createFileRoute("/privacy-policy")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Learn how LINEA collects, uses, and protects your personal information.",
      },
      {
        property: "og:title",
        content: `Privacy Policy | ${SITE_NAME}`,
      },
      {
      ...
      { name: "twitter:title", content: `Privacy Policy | ${SITE_NAME}` },
      {
