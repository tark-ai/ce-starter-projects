<!-- Platform chrome, not brand chrome: this badge is identical across all five
     Soja apps, so it is generated from @ce/soja-ui's powered-by-badge.tsx and
     must not be restyled to the brand's square/bone language. -->
<a
	href="https://www.commercengine.io"
	target="_blank"
	rel="noopener noreferrer"
	class="fixed bottom-4 right-4 z-50 flex items-center gap-2 rounded-full bg-white px-3.5 py-2 shadow-md ring-1 ring-neutral-200 transition-shadow hover:shadow-lg"
>
	<svg
	...
	>
		<path
			d="M365.436 1000H776.54L913.575 863.655V727.311H365.436V1000Z"
			fill="#00BF6F"
		/>
		<path
			d="M274.069 1000H137.081L0.0461426 863.655V727.311H274.069V1000Z"
			fill="#8EDD65"
		/>
		<path
			d="M274.069 363.639H0V636.328H274.069V363.639Z"
			fill="#3CDBC0"
		/>
		<path
		...
		/>
		<path
			d="M548.139 0H137.081L0 136.36V272.704H548.2L548.139 0Z"
			fill="#00BF6F"
		/>
	</svg>
	<span class="whitespace-nowrap text-xs font-medium text-neutral-500">
