...
export const Route = createFileRoute("/about/size-guide")({
  head: () => ({
    meta: [
      {
      ...
      { property: "og:url", content: `${SITE_URL}/about/size-guide` },
      { property: "og:image", content: `${SITE_URL}/og-image.jpg` },
      { property: "og:image:width", content: "1200" },
      { property: "og:image:height", content: "630" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: `Size Guide | ${SITE_NAME}` },
      {
    ...
    links: [{ rel: "canonical", href: `${SITE_URL}/about/size-guide` }],
  }),
