  ...
  head: () => ({
    meta: [
      ...
      },
      {
        name: "description",
        content:
          "Find a Linea jewelry store near you. Visit us in New York or Beverly Hills for a personalized jewelry experience.",
      },
      {
        property: "og:title",
        content: `Store Locator | ${SITE_NAME}`,
      },
      { property: "og:type", content: "website" },
      { property: "og:url", content: `${SITE_URL}/about/store-locator` },
    ],
    links: [{ rel: "canonical", href: `${SITE_URL}/about/store-locator` }],
  }),
        ...
        <ContentSection title="Virtual Consultations">
          <div className="bg-muted/10 rounded-lg p-8">
            ...
            <p className="text-muted-foreground mb-6">
              ...
              video call, answer your questions, and help you make the perfect selection from the
