    ...
    <div className="min-h-screen bg-background">
      ...
      <main>
        ...
        <ContentSection title="Introduction">
          <p>
            Little Things ("we," "our," or "us") respects your privacy and is committed to
            protecting your personal data. This policy explains what we collect, how we use it, and
            the choices you have when you browse, buy, or get in touch.
          </p>
        </ContentSection>
        ...
        <ContentSection title="Information we collect">
          ...
          <p>
            We also collect basic usage data automatically, such as your device type, browser, and
            the pages you visit, so we can keep the site fast and fix what's broken.
          </p>
        </ContentSection>
