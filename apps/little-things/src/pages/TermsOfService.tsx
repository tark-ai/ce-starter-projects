      ...
      <main>
        ...
        <ContentSection title="Using our store">
          <p>
            ...
            misuse the site, interfere with its operation, or attempt to access it in ways we
            haven't intended.
          </p>
        </ContentSection>
        ...
        <ContentSection title="Returns and refunds">
          <p>
            Most items can be returned within 30 days in their original condition. Refunds are
            issued to your original payment method once we've received and checked the return. Some
            items may be excluded — we'll always say so on the product page.
          </p>
        </ContentSection>
        ...
        <ContentSection title="Limitation of liability">
          <p>
            ...
            Little Things isn't liable for any indirect or incidental damages arising from your use
            of the site.
          </p>
        </ContentSection>
