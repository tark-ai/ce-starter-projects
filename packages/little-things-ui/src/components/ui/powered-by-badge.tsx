...
export function PoweredByBadge() {
  return (
    <a
      ...
      className="fixed bottom-4 right-4 z-50 flex items-center gap-2 rounded-full bg-card px-3.5 py-2 shadow-md ring-1 ring-border transition-shadow hover:shadow-lg"
    >
