...
export const metadata: Metadata = {
  title: "About",
  description: `${SITE_NAME} sells the good stuff, minus the fluff — a tight, opinionated catalog where everything earns its spot.`,
  openGraph: {
    title: `About | ${SITE_NAME}`,
    description: `${SITE_NAME} sells the good stuff, minus the fluff.`,
    type: "website",
    url: `${SITE_URL}/about`,
  },
};
